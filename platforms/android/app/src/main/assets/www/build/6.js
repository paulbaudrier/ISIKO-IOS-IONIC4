...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__my_profile__ = __webpack_require__(771);
...
var MyProfilePage = /** @class */ (function () {
    ...
    MyProfilePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-my-profile',template:/*ion-inline-start:"C:\Users\Paul\Desktop\GOOD FIREBASE\TRY\ISIKO-IOS-MASTER\src\pages\my-profile\my-profile.html"*/'<ion-header>\n\n  <ion-navbar hideBackButton="true">\n\n    <ion-title>Mon Profil</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content padding>\n\n  <ion-card>\n\n    <img [src]="user.image"/>\n\n    <ion-card-content>\n\n      <ion-card-title>\n\n        {{user.name}}\n\n      </ion-card-title>\n\n      <p>\n\n        Bonjour,{{user.name}}.\n\n        <br> \n\n        Vous trouverez ici les informations de votre profil !\n\n      </p>\n\n    </ion-card-content>\n\n    <br>\n\n    <button ion-button block type="button" (click)=\'logout()\'>Se déconnecter</button>\n\n  </ion-card>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\Paul\Desktop\GOOD FIREBASE\TRY\ISIKO-IOS-MASTER\src\pages\my-profile\my-profile.html"*/,
        }),
